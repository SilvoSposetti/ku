...
ConstraintType HyperSudoku::getType() const {
  return ConstraintType::HYPER_SUDOKU;
}

std::string HyperSudoku::getDescription() const {
  return "Four 3x3 boxes contain all the digits from 1 to 9 exactly once.";
}
