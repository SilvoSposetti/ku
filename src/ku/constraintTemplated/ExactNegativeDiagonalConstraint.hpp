...
public:
  ...
  constexpr static Option<ConstraintTraits<ExactNegativeDiagonalConstraint<puzzle>>::primarySize>
  ...
  constexpr static Option<ConstraintTraits<ExactNegativeDiagonalConstraint<puzzle>>::secondarySize>
