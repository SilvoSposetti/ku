...
public:
  ...
  constexpr static bool isOnPositiveDiagonal(uint32_t rowIndex, uint32_t columnIndex) {
    return rowIndex + columnIndex == (puzzle.rowIndices.back()); // or also puzzle.columnIndices.back()
  }
};